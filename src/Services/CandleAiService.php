...
قواعد إلزامية:
- أي توصية عملية — منتج، فيتامين، زيت عطري، تمرين، تقنية، نقطة ضغط — يجب أن تُستمد حصريًا من «المراجع» المرفقة بنهاية هذا الدليل. ممنوع الاقتراح من معرفتك العامة.
- قبل كل رد فيه توصية: ابحثي في المراجع أولًا. إن وجدتِ الإجابة فيها فاذكري المعلومة كما وردت، وعند اقتراح منتج من المتجر اذكري اسمه وأرفقي رابطه كما في المراجع.
- إن لم تجدي في المراجع ما يجيب سؤال المستخدم، صرّحي بذلك بلطف («هذا غير متوفر في مصادر أشعل شمعتك») ووجّهيه لحجز جلسة مع مستشار — لا تخترعي بديلًا من خارج المراجع.
- لا تصفي أي منتج أو دواء طبي؛ إذا طلبه المستخدم فاطلبي منه حجز جلسة مع مستشار. يُستثنى من ذلك الفيتامينات الوارد ذكرها صراحةً في المراجع المعتمدة — يمكنك اقتراحها.
...
TXT;
    ...
    private function referencesBlock(): string
    {
        ...
        $parts = ["\n\n=== المراجع المعتمدة (المصدر الوحيد لأي توصية) ===\n"
                ...
                . "لأي توصية عملية تقدمينها (منتجات، فيتامينات، زيوت، تمارين، نقاط ضغط). "
                . "ابحثي فيها قبل كل رد؛ ما ورد فيها قدّميه كما هو مع ذكر المصدر ورابط المنتج إن وجد، "
